...
class JSONFileDataLoader(FileDataLoader):
    ...
    def next_one(self, N, K, Q, noise_rate=0):
        ...
        #print(len(self.rel2scope.keys()))
        #print(self.rel2scope)
        ...
        for i, class_name in enumerate(target_classes):
            ...
            indices = np.random.choice(list(range(scope[0], scope[1])), K + Q, False)#K+Q=6
            #indices = np.random.choice(list(range(0, 10)), 2, False)  # K+Q=6
            #print(indices)
            #print(self.data_word.shape)
            word = self.data_word[indices]#"word" is the unique id of words in every sentence,
            #print(word)
